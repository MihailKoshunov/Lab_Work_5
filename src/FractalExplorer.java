...
public class FractalExplorer {
    ...
    public void setGUI() {
        ...
        // выпадающий список с фракталами
    ...
    public class ActionHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getActionCommand().equals("Reset")) {
                ...
                // Сохраняем только PNG картинку.
                FileNameExtensionFilter fileFilter = new FileNameExtensionFilter("PNG Images", "png");
                fileChooser.setFileFilter(fileFilter);
                //Гарантируем что средство выбора не разрешит пользователю использование отличных от png форматов
